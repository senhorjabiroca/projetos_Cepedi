const apiKey = 'd74f5f5b75869b4d2d96f8164d30d6fc'; // Substitua pela sua chave de API
...
let table: HTMLTableElement | null = null; // Inicializando a variável com o tipo correto
